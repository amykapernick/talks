...
<Slide type="section">
	...
	<Slide type="quote">
		<blockquote>
			...
			<cite>Larene Le Gassick, <small>Accessibility Expert</small></cite>
			{/* TODO: Larene's title and tweet URL */}
		</blockquote>
		<Notes slot="notes">
...
<Slide type="section">
	...
	<Slide>
		...
		<Notes slot="notes">
			...
			- And have a look at what skills assessments you're giving them during the hiring process, if someone is being hired as an accessibility expert, someone who is just going to be working on the front end, as a specialist, do they really need to be able to answer questions about computer science?
			{/* TODO: find weird CS question to include here */}
		</Notes>
	</Slide>
...
<Slide type="section">
	...
	<Slide type="code" size="small">
		```html
			<img src="my_chart.jpg" aria-labelledby="label" />
...
{/* TODO: add slides link and publish slides/info/resources links */}
<Slide>
	kapers.dev/dddbne23
	<Notes slot="notes">
		- 
