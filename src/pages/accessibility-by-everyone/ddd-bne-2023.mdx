...
{/* TODO: MAke transition better and add blank screen */}
	<Slide>
...
{/* TODO: AUD and make it blank to start, reword notes */}
	<Slide>
		1 million views/day <span class="fragment">→ €2.3 million/year</span>
		<Notes slot="notes">
			- A study done by Microsoft and Forrester have estimated that an average European company with a website that gets 1 million site visits per day
			- Based on the percentage of users with disabilities who abandon online purchases due to accessibility issues
...
{/* TODO: webaim is? */}
	<Slide>
		1,000,000 sites
		<Notes slot="notes">
			- Each year WebAIM does a study on the top million homepages
...
{/* TODO: Make list or cloud */}
	<Slide>
		Colour Contrast, Missing Alt Text, Empty Links/Buttons, Missing Form Labels, Missing Document Language
		<Notes slot="notes">
