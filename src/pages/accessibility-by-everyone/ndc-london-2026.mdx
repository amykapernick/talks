...
import Feedback from './ndc-london-2026.png'
...
<Slide type="section">
	...
	>
		<Notes slot="notes">
			...
			- Let's take a look at some of the ways we can all help
		</Notes>
	</Slide>
	...
	<Slide>
		...
		<Notes slot="notes">
			...
			- That includes hiring experts in accessibility or just people who have an interest are want to make a difference
			- And have a look at what skills assessments you're giving them during the hiring process, if someone is being hired as an accessibility expert, someone who is just going to be working on the front end, as a specialist, do they really need to be able to answer questions about computer science and algorithms?
		</Notes>
	</Slide>
	...
	<Slide>
		...
		<Notes slot="notes">
			...
			- Most of the time you'll want a base size of at least 16px
		</Notes>
	</Slide>
	...
	<Slide>
		...
		<Notes slot="notes">
			...
			- There are also ways developers can check for people's preferences and disable animations if they've opted out
		</Notes>
	</Slide>
	...
	<Slide>
		...
		Testing Procedures
		<Notes slot="notes">
			- Accessibility has options for both manual and automated testing
			- Manual testing includes checking things such as keyboard navigation and screen reader compatibility
			- Automatic testing can capture things like colour contrast, HTML validation and text Alternatives
			- It's good to have a combination of manual and automated tests to make sure you're catching everything
		</Notes>
	</Slide>
	...
	<Slide>
		...
		MFA
		<Notes slot="notes">
			- When using multi-factor authentication, consider people's capabilities, some people may struggle to access and enter the code before it times out
...
<Slide type="section">
	...
	<Slide>
		...
		<Notes slot="notes">
			...
			- In 2025, from those 1 million websites...
		</Notes>
	</Slide>

	<Slide>
		50,960,288 accessibility issues
		<Notes slot="notes">
			- ...they found 50 million, 960 thousand, 288 accessibility issues
			- That's an average of almost 51 errors per site, just on the homepage
	...
	<Slide>
		94.8% failed
		<Notes slot="notes">
			- Of those 1 million websites, 94.8% failed to meet accessibility guidelines
			- That means that almost 95%, that's 950,000 of these websites were built without considering the billions of people who need accessibility features to use them
	...
	<Slide>
		## <small>Disclaimer:</small><br/> Not a Lawyer
		<Notes slot="notes">
...
<Slide type="section">
	...
	<Slide>
		WCAG 2.2
		<Notes slot="notes">
			- The most current version of the guidlines is WCAG 2.2 which was published in October 2023
	...
	<Slide>
		A - AA - AAA
		<Notes slot="notes">
			- If you're complying with the EAA, their web requirements are based off WCAG 2.1 AA standard, with a few extra bits added (again, consult a lawyer and get an accessibility audit done if this applies to you)
			- There's also work being done to update the guidelines to WCAG version 2.2 so it doesn't hurt to get started on meeting the newer version if you're implementing changes
		</Notes>
	</Slide>
	...
	>
		...
		<Notes slot="notes">
			- As I mentioned, WCAG 2.2 came out a while back, there are a bunch of great explainers that go through the guidelines and what the changes are
		</Notes>
	</Slide>
	...
	<Slide>
		...
		<Notes slot="notes">
			...
			- 50 million, 960 thousand, 288 accessibility issues
		</Notes>
	</Slide>
	...
	<Slide>
		96% easy fixes
		<Notes slot="notes">
			- Of those, 96% are easily fixable
		</Notes>
	</Slide>

	<Slide>
		48,921,876 easy fixes
		<Notes slot="notes">
	...
	<Slide>
		...
		Colour Contrast
		<Notes slot="notes">
			- Colour contrast compares the difference between the background and text colours to ensure that there's enough difference between the two that they can be easily read
			- Almost 80% of the sites tested had areas with insufficient colour contrast
	...
	<Slide>
		...
		<Notes slot="notes">
			...
			- 55.5% of the sites tested were missing the alt text on images
		</Notes>
	</Slide>
	...
	<Slide type="code" size="small">
		...
		<Notes slot="notes">
			- You can use attributes like `aria-labelledby` and `aria-describedby` which allow you to link a description with a visual element like an image
	...
	<Slide type="quote">
		...
		<Notes slot="notes">
			- On the note of ARIA, the first official rule of ARIA (from their website) is if you don't have to use it, don't
		</Notes>
	</Slide>
	...
	<Slide type="code" size="small">
		```html
		<label for="header_search" class="hidden">Search</label>
		
		<input id="header_search" name="search" placeholder="Search" type="search" />
		```
		<Notes slot="notes">
			- Of the tested websites, over 48% were missing labels on form inputs
			- Which given these are homepages being tested, are probably a lot of search inputs which just need to have a hidden label being added
		</Notes>
	</Slide>
	...
	<Slide>
		...
		Training
		<Notes slot="notes">
			- I'm going to assume that all of you know how important training and personal development is, you've given up your Saturdays to come and learn new things and see some amazing speakers and presentations
			- There's plenty of options for training and upskilling around accessibility so find one that works for you or your team, in a format that works for them (some people prefer in person workshops, some self paced online, some books/blogs)
		</Notes>
	</Slide>
	...
	>
		...
		<Notes slot="notes">
			- Intopia is a digital agency that specialises in accessibility, they have a heap of different courses available
...
<Slide>
	...
	<Notes slot="notes">
		- Accessibility is not a "nice to have", a "we'll do it later" or a "additional feature"
		- Accessibility makes a huge different in the lives of billions of people
		- And inaccessibility excludes them from the technology that makes the rest of our lives easier
		- It excludes them from being a part of society and tells them they're not welcome
	</Notes>
</Slide>
...
<Slide>
	...
	<Notes slot="notes">
		- And accessibility isn't just for the 1.2 billion people with permanent impairments, it helps all of us and makes all our lives better
		- Accessibility helps us every day, even when we don't know it
	</Notes>
</Slide>
...
<Slide>
	...
	<Notes slot="notes">
		- And most importantly, we can all play a part in making our website, our products, out technologies more accessible
		- We can all make a change, take a small step, learn one little things that makes a big difference to someone who relies on accessibility to just exist in this technology dependant world
	</Notes>
</Slide>
