...
<Slide type="figure" image={GitHubRepo} caption="kapers.dev/workshop">
	<Notes slot="notes">
		...
		- Can run in codespaces or dev containers
	</Notes>
</Slide>
...
<Slide id="a11y" type="section">
	...
	<Slide>
		Semantic HTML
		<Notes slot="notes">
			- Similar to what typscript does for JavaScript, semantic HTML gives meaning to the content rather than just being a generic `any` value like a `div` or `span`
		</Notes>
	</Slide>
	...
	<Slide type="code" size="small">
		...
		<Notes slot="notes">
			...
			- Using correct, semantic HTML is one of the best things we can do as developers to improve the accessibility of what we're building
		</Notes>
	</Slide>
